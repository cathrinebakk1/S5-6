import random
drinks = ["vodka", "tequila", "rum", "gin", "beer", "seltzer", "wine", "akevitt", "jeger"]
try:
    name = input("What is your name? ")
    age = input("How old are you? ")
    age = int(age) # convert string to ineger
    ...
    # now we have a good age to play with
        ...
        print("You are not allowed to drink in USA or UAE. You can not play this awsome drinking game")
    else:
